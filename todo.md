...
- Agent coordinator in `internal/agent/coordinator.go` (~900 lines)
- Supports: OpenAI, Anthropic, OpenRouter, Mistral (via openai-compat)
- Local providers: Devstral (via proxy at localhost:9000)
