...
- **ARCHITECTURE**: This file - System architecture, code style, and development standards
- **🔄 OPERATIONS**: [`PROJECT_OPERATIONS.md`](PROJECT_OPERATIONS.md) - Daily workflows, Git operations, testing procedures
- **📖 REFERENCE**: [`CODEDOCS.md`](CODEDOCS.md) - Complete code index with search guide
- **📋 TASKS**: [`todo.md`](todo.md) - Current issues, bugs, and improvement opportunities
...
- **Lint**: `./scripts/lint.sh` (comprehensive quality checks)
- **Format**: `gofumpt -w .`
- **Dev**: `go run .` (or use debug flags as needed)

> **⚡ Quick Quality Check**: Run `./scripts/lint.sh` for comprehensive build, test, and code quality validation. See `PROJECT_OPERATIONS.md` for detailed workflow procedures.
> 
> **🔍 Code Navigation**: Use [`CODEDOCS.md`](CODEDOCS.md) to search our 40,000+ lines of new code. Search for `SymbolStore`, `FileWatcher`, `devstral`, `QueryEngine`, etc.
...
- **Terse mode**: Minimal output (under 4 lines), focus on facts, no preamble
- One-word answers when possible
- Full implementation, not sketches
