...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View nexora logs",
	Long:  `View the logs generated by Nexora. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.Options.DataDirectory, "logs", "nexora.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a nexora project. No logs found.")
			return nil
		}
