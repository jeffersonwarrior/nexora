...
var dirsCmd = &cobra.Command{
	Use:   "dirs",
	Short: "Print directories used by Nexora",
	Long: `Print the directories where Nexora stores its configuration and data files.
...
var configDirCmd = &cobra.Command{
	Use:   "config",
	Short: "Print the configuration directory used by Nexora",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfig()))
	},
}
...
var dataDirCmd = &cobra.Command{
	Use:   "data",
	Short: "Print the datauration directory used by Nexora",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfigData()))
	},
}
