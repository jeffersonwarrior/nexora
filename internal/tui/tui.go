...
import (
	...
	cmpChat "github.com/nexora/cli/internal/tui/components/chat"
	"github.com/nexora/cli/internal/tui/components/chat/splash"
	"github.com/nexora/cli/internal/tui/components/completions"
	"github.com/nexora/cli/internal/tui/components/core"
	"github.com/nexora/cli/internal/tui/components/core/status"
	"github.com/nexora/cli/internal/tui/components/dialogs"
	"github.com/nexora/cli/internal/tui/components/dialogs/commands"
	"github.com/nexora/cli/internal/tui/components/dialogs/filepicker"
	"github.com/nexora/cli/internal/tui/components/dialogs/models"
	"github.com/nexora/cli/internal/tui/components/dialogs/permissions"
	"github.com/nexora/cli/internal/tui/components/dialogs/quit"
	"github.com/nexora/cli/internal/tui/components/dialogs/sessions"
	"github.com/nexora/cli/internal/tui/page"
	"github.com/nexora/cli/internal/tui/page/chat"
...
const (
	// UI Layout Constants
	fullHelpHeightReduction    = 5 // Space reserved when showing full help
	minimalHelpHeightReduction = 2 // Space reserved when showing minimal help

	// Mouse Debounce Constants
	mouseEventDebounceDelay = 15 * time.Millisecond // Prevents trackpad overwhelming

	// Size Constraints
	minWindowWidth  = 25 // Minimum window width for functionality
	minWindowHeight = 15 // Minimum window height for functionality

	// Animation Constants
	cacheTTL = 10 * time.Second // Cache duration for temporary data
)
