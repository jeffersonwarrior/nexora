...
// TestClient is skipped when running with the race detector due to an upstream
...
func TestClient(t *testing.T) {
	t.Skip("Skipping TestClient with race detector due to upstream race in powernap library")
}
